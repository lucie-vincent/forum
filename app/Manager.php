...
abstract class Manager{
     ...
     */
    // cette méthode permet de lister les enregristrements d'une table
    public function findAll($order = null){

        // le tri/classement des données
        $orderQuery = ($order) ?                 
        ...
        // on utilise la méthode getMultipleResults() car la requête renvoie plusieurs enregistrements
