...
INSERT INTO `post` (`id_post`, `content`, `creationDate`, `topic_id`, `user_id`) VALUES
	(13, 'Tell us what you think and if you experience any bug', '2024-04-17', 1, 1),
	(14, 'works fine for me!', '2024-04-17', 1, 8),
	(15, 'I\'ve tried this game and here\'s why you should too', '2024-04-18', 2, 8),
	(16, 'I love it as well', '2024-04-18', 2, 9),
	(17, 'I hate it', '2024-04-19', 3, 9),
	(18, 'I thought it was ok', '2024-04-19', 3, 10);
...
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `isLocked`, `category_id`, `user_id`) VALUES
	(1, 'App has been updated', '2024-04-17', 0, 6, 1),
	(2, 'Pagan is the best!', '2024-04-17', 0, 7, 8),
	(3, 'Vindication is the worst', '2024-04-18', 0, 7, 9);
...
-- Listage des données de la table lucie_forum.user : ~4 rows (environ)
INSERT INTO `user` (`id_user`, `nickname`, `email`, `password`, `role`, `registerDate`) VALUES
	(1, 'lulu', 'lucie@exemple.com', '$2y$10$zIs2ZA.BuKpKwEreqC63Wu7xt2tuFDkQ6vrskk6QZhpPJXepxWW2K', '["ROLE_USER", "ROLE_ADMIN"]', '2024-04-18'),
	...
	(10, 'user3', 'user3@exemple.com', '$2y$10$uwH5uDo/bytJQHiCssQfdO8pwFvxR8BM5pTfwjbPWA3PFSb24Gziq', '["ROLE_USER"]', '2024-04-19');
